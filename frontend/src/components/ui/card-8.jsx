        ...
        {isVisible && (
          <motion.div
            ...
            className={cn(
              ...
              "bg-status-verified text-white", // Customized for Geo-Trust success theme
              className
            )}
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mt-6">
              <Button
                className="w-full rounded-full bg-white py-6 text-base font-semibold text-primary-main shadow-lg transition-transform duration-200 hover:bg-white/90 active:scale-95"
